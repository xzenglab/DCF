% This code is based on the deepmat code by Ha Wang and KyungHyun Cho, 
%
...
%         load(my.save);
%         m_V = v_v;
        m_V = dlmread(sprintf('%s/final-V_1.dat',my.save));
        m_V = m_V(perm_idx,:);
    end
...
%        save(my.save,'v_v');
    ...
    if step==1
        dlmwrite(sprintf('%s/final-V_1.dat',my.save),m_theta,'delimiter',' ');
    end
